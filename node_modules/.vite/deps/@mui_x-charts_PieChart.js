...
var require_colorManipulator = __commonJS({
  "node_modules/@mui/system/colorManipulator.js"(exports) {
    ...
    function clampWrapper(value, min4 = 0, max4 = 1) {
      ...
      return (0, _clamp.default)(value, min4, max4);
    }
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : (0, _formatMuiErrorMessage2.default)(10, colorSpace));
    ...
    function getLuminance2(color3) {
      color3 = decomposeColor2(color3);
      let rgb3 = color3.type === "hsl" || color3.type === "hsla" ? decomposeColor2(hslToRgb4(color3)).values : color3.values;
      rgb3 = rgb3.map((val) => {
    ...
    function blend(background, overlay, opacity, gamma2 = 1) {
      ...
      const rgb3 = [blendChannel(backgroundColor2.values[0], overlayColor.values[0]), blendChannel(backgroundColor2.values[1], overlayColor.values[1]), blendChannel(backgroundColor2.values[2], overlayColor.values[2])];
      return recomposeColor2({
        type: "rgb",
        values: rgb3
      });
  ...
  "node_modules/@mui/system/createTheme/createBreakpoints.js"(exports) {
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit: unit2 = "px",
        step = 5
      } = breakpoints, other = (0, _objectWithoutPropertiesLoose2.default)(breakpoints, _excluded38);
      ...
      function between(start3, end2) {
        ...
        return `@media (min-width:${typeof values2[start3] === "number" ? values2[start3] : start3}${unit2}) and (max-width:${(endIndex !== -1 && typeof values2[keys[endIndex]] === "number" ? values2[keys[endIndex]] : end2) - step / 100}${unit2})`;
      }
      function only(key) {
        ...
        function traverse(sxInput) {
          ...
          Object.keys(sxObject).forEach((styleKey) => {
            ...
            if (value !== null && value !== void 0) {
              if (typeof value === "object") {
                if (config2[styleKey]) {
                  css2 = (0, _merge.default)(css2, getThemeValue(styleKey, value, theme, config2));
                } else {
...
var require_applyStyles = __commonJS({
  "node_modules/@mui/system/createTheme/applyStyles.js"(exports) {
    ...
    function applyStyles3(key, styles) {
      const theme = this;
  ...
  "node_modules/@mui/system/createTheme/createTheme.js"(exports) {
    ...
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = (0, _objectWithoutPropertiesLoose2.default)(options, _excluded38);
...
var require_extendSxProp = __commonJS({
  "node_modules/@mui/system/styleFunctionSx/extendSxProp.js"(exports) {
    ...
    function extendSxProp2(props) {
      const {
        sx: inSx
      } = props, other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded38);
      const {
        systemProps,
        otherProps
      } = splitProps2(other);
...
var require_createStyled = __commonJS({
  "node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded38);
      ...
      if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
        const {
          variants = []
        } = resolvedStylesArg, otherStyles = (0, _objectWithoutPropertiesLoose2.default)(resolvedStylesArg, _excluded213);
    ...
    function createStyled5(input = {}) {
      ...
      return (tag, inputOptions = {}) => {
        ...
        } = inputOptions, options = (0, _objectWithoutPropertiesLoose2.default)(inputOptions, _excluded39);
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    Object.keys(palette2).forEach((color3) => {
      ...
      if (colors3 && typeof colors3 === "object") {
        if (colors3.main) {
          setColor(palette2[color3], "mainChannel", (0, import_colorManipulator2.private_safeColorChannel)(toRgb(colors3.main)));
        }
        if (colors3.light) {
          setColor(palette2[color3], "lightChannel", (0, import_colorManipulator2.private_safeColorChannel)(toRgb(colors3.light)));
        }
        if (colors3.dark) {
          setColor(palette2[color3], "darkChannel", (0, import_colorManipulator2.private_safeColorChannel)(toRgb(colors3.dark)));
        }
        if (colors3.contrastText) {
          setColor(palette2[color3], "contrastTextChannel", (0, import_colorManipulator2.private_safeColorChannel)(toRgb(colors3.contrastText)));
        }
        if (color3 === "text") {
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React35.useMemo(() => ({
...
var DrawingContext = React36.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React36.createContext({
  current: null
});
if (true) {
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const value = React36.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea), [chartId, drawingArea]);
  return (0, import_jsx_runtime15.jsx)(SvgContext.Provider, {
    value: svgRef,
    children: (0, import_jsx_runtime15.jsx)(DrawingContext.Provider, {
      value,
      children
    })
  });
...
function stack_default() {
  ...
  stack.order = function(_) {
    return arguments.length ? (order3 = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default(Array.from(_)), stack) : order3;
  };
...
function diverging_default(series, order3) {
  if (!((n = series.length) > 0))
    return;
  for (var i, j = 0, d, dy, yp, yn, n, m = series[order3[0]].length; j < m; ++j) {
    for (yp = yn = 0, i = 0; i < n; ++i) {
      if ((dy = (d = series[order3[i]][j])[1] - d[0]) > 0) {
        d[0] = yp, d[1] = yp += dy;
      } else if (dy < 0) {
        d[1] = yn, d[0] = yn += dy;
      } else {
...
function insideOut_default(series) {
  var n = series.length, i, j, sums = series.map(sum), order3 = appearance_default(series), top3 = 0, bottom3 = 0, tops = [], bottoms = [];
  for (i = 0; i < n; ++i) {
    j = order3[i];
    if (top3 < bottom3) {
      top3 += sums[j];
    ...
    defaultizedSeries[seriesId] = _extends({
      ...
      data: series[seriesId].data.map((item, index2) => _extends({}, item, {
        ...
        return _extends({}, item, {
          formattedValue: ((_b = (_a = series[seriesId]).valueFormatter) == null ? void 0 : _b.call(_a, item, {
            dataIndex: index2
...
var SeriesContext = React37.createContext({});
if (true) {
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React37.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
  return (0, import_jsx_runtime16.jsx)(SeriesContext.Provider, {
...
var clamp2 = (min4, max4, v) => Math.min(Math.max(v, min4), max4);
var colors2 = {
  transparent: 0,
...
var prefix3 = "react-spring: ";
var once = (fn2) => {
  const func = fn2;
  let called = false;
  if (typeof func != "function") {
    throw new TypeError(`${prefix3}once requires a function parameter`);
  }
  return (...args) => {
    if (!called) {
      func(...args);
...
function deprecateInterpolate() {
  warnInterpolate(
    `${prefix3}The "interpolate" function is deprecated in v9 (use "to" instead)`
  );
}
var warnDirectCall = once(console.warn);
function deprecateDirectCall() {
  warnDirectCall(
    `${prefix3}Directly calling start instead of using the api object is deprecated in v9 (use ".start" instead), this will be removed in later 0.X.0 versions`
  );
}
...
function useForceUpdate() {
  const update22 = (0, import_react9.useState)()[1];
...
var useOnce = (effect4) => (0, import_react13.useEffect)(effect4, emptyDeps);
var emptyDeps = [];
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react16.useRef)(null);
    ...
    const observerRef = (0, import_react16.useRef)();
    useIsomorphicLayoutEffect(() => {
    ...
    return React39.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringValue = class extends FrameValue {
    ...
    anim.values.forEach((node22, i) => {
      ...
      if (!finished) {
        ...
        if (!is.und(config2.duration)) {
          ...
          position3 = from2 + config2.easing(p) * (to22 - from2);
          velocity = (position3 - node22.lastPosition) / dt;
          finished = p == 1;
        } else if (config2.decay) {
          const decay = config2.decay === true ? 0.998 : config2.decay;
          const e = Math.exp(-(1 - decay) * elapsed);
          position3 = from2 + v0 / (1 - decay) * (1 - e);
          finished = Math.abs(node22.lastPosition - position3) <= precision;
          velocity = v0 * e;
        } else {
          ...
          const isGrowing = from2 == to22 ? node22.v0 > 0 : from2 < to22;
          let isMoving;
          ...
          for (let n = 0; n < numSteps; ++n) {
            ...
            if (!isMoving) {
              finished = Math.abs(to22 - position3) <= precision;
              if (finished) {
                break;
              }
            }
            if (canBounce) {
              isBouncing = position3 == to22 || position3 > to22 == isGrowing;
              if (isBouncing) {
                velocity = -velocity * bounceFactor;
                position3 = to22;
              }
            }
            const springForce = -config2.tension * 1e-6 * (position3 - to22);
      ...
      if (node22.setValue(position3, config2.round)) {
        changed = true;
      }
    });
    const node2 = getAnimated(this);
  ...
  _prepareNode(props) {
    ...
    const range2 = { to: to22, from: from2 };
    if (!hasAnimated(this)) {
      if (props.reverse)
  ...
  _merge(range2, props, resolve) {
    ...
    let { to: to22 = prevTo, from: from2 = prevFrom } = range2;
...
var SpringContext = ({
  ...
  const inherited = (0, import_react18.useContext)(ctx);
  const pause = props.pause || !!inherited.pause, immediate = props.immediate || !!inherited.immediate;
  props = useMemoOne(() => ({ pause, immediate }), [pause, immediate]);
  const { Provider } = ctx;
  return React40.createElement(Provider, { value: props }, children);
};
...
function useTransition(data, props, deps) {
  ...
  const ref = (0, import_react20.useMemo)(
...
var prefixKey = (prefix4, key) => prefix4 + key.charAt(0).toUpperCase() + key.substring(1);
var prefixes = ["Webkit", "Ms", "Moz", "O"];
isUnitlessNumber = Object.keys(isUnitlessNumber).reduce((acc, prop) => {
  prefixes.forEach((prefix4) => acc[prefixKey(prefix4, prop)] = acc[prop]);
  return acc;
}, isUnitlessNumber);
...
function bisector(f) {
  ...
  function left3(a2, x2, lo = 0, hi = a2.length) {
    if (lo < hi) {
      if (compare1(x2, x2) !== 0)
        return hi;
      do {
  ...
  function right3(a2, x2, lo = 0, hi = a2.length) {
    if (lo < hi) {
      if (compare1(x2, x2) !== 0)
        return hi;
      do {
...
function blurfImage(radius) {
  ...
  return (T, S, start3, stop2, step) => {
    start3 <<= 2, stop2 <<= 2, step <<= 2;
    blur3(T, S, start3 + 0, stop2 + 0, step);
    blur3(T, S, start3 + 1, stop2 + 1, step);
    blur3(T, S, start3 + 2, stop2 + 2, step);
    blur3(T, S, start3 + 3, stop2 + 3, step);
  };
}
function blurf(radius) {
  ...
  const w = 2 * radius + 1;
  return (T, S, start3, stop2, step) => {
    if (!((stop2 -= step) >= start3))
      return;
    let sum3 = radius0 * S[start3];
    const s0 = step * radius0;
    const s1 = s0 + step;
    for (let i = start3, j = start3 + s0; i < j; i += step) {
      sum3 += S[Math.min(stop2, i)];
    }
    for (let i = start3, j = stop2; i <= j; i += step) {
      sum3 += S[Math.min(stop2, i + s0)];
      T[i] = (sum3 + t * (S[Math.max(start3, i - s1)] + S[Math.min(stop2, i + s1)])) / w;
      sum3 -= S[Math.max(start3, i - s0)];
    }
  };
}
...
var e5 = Math.sqrt(10);
var e2 = Math.sqrt(2);
function tickSpec(start3, stop2, count2) {
  const step = (stop2 - start3) / Math.max(0, count2), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1;
  let i1, i2, inc;
  if (power < 0) {
  ...
  if (i2 < i1 && 0.5 <= count2 && count2 < 2)
    return tickSpec(start3, stop2, count2 * 2);
  return [i1, i2, inc];
}
function ticks(start3, stop2, count2) {
  ...
  if (start3 === stop2)
    return [start3];
  const reverse2 = stop2 < start3, [i1, i2, inc] = reverse2 ? tickSpec(stop2, start3, count2) : tickSpec(start3, stop2, count2);
  if (!(i2 >= i1))
    return [];
...
function tickStep(start3, stop2, count2) {
  stop2 = +stop2, start3 = +start3, count2 = +count2;
  const reverse2 = stop2 < start3, inc = reverse2 ? tickIncrement(stop2, start3, count2) : tickIncrement(start3, stop2, count2);
...
function band() {
  ...
  function rescale() {
    var n = domain().length, reverse2 = r1 < r0, start3 = reverse2 ? r1 : r0, stop2 = reverse2 ? r0 : r1;
...
function hslConvert(o) {
  ...
  if (o instanceof Hsl)
    return o;
  o = o.rgb();
  var r2 = o.r / 255, g = o.g / 255, b = o.b / 255, min4 = Math.min(r2, g, b), max4 = Math.max(r2, g, b), h = NaN, s2 = max4 - min4, l = (max4 + min4) / 2;
  if (s2) {
    if (r2 === max4)
      h = (g - b) / s2 + (g < b) * 6;
    else if (g === max4)
...
function hsl3(hue2) {
  return function(start3, end2) {
    var h = hue2((start3 = hsl2(start3)).h, (end2 = hsl2(end2)).h), s2 = nogamma(start3.s, end2.s), l = nogamma(start3.l, end2.l), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t) {
      start3.h = h(t);
      start3.s = s2(t);
      start3.l = l(t);
...
function hcl2(hue2) {
  return function(start3, end2) {
    var h = hue2((start3 = hcl(start3)).h, (end2 = hcl(end2)).h), c = nogamma(start3.c, end2.c), l = nogamma(start3.l, end2.l), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t) {
      start3.h = h(t);
      start3.c = c(t);
      start3.l = l(t);
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    var prefix4 = symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : "", suffix = symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "";
    var formatType = formatTypes_default[type], maybeSuffix = /[defgprs%]/.test(type);
    precision = precision === void 0 ? 6 : /[gprs]/.test(type) ? Math.max(1, Math.min(21, precision)) : Math.max(0, Math.min(20, precision));
    function format2(value) {
      var valuePrefix = prefix4, valueSuffix = suffix, i, n, c;
      if (type === "c") {
  ...
  function formatPrefix2(specifier, value) {
    var f = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k2 = Math.pow(10, -e), prefix4 = prefixes2[8 + e / 3];
    return function(value2) {
      return f(k2 * value2) + prefix4;
    };
  }
  return {
    format: newFormat,
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start3, stop2, count2) {
  ...
  function tickInterval(start3, stop2, count2) {
    ...
    if (i === tickIntervals.length)
      return year.every(tickStep(start3 / durationYear, stop2 / durationYear, count2));
    if (i === 0)
      return millisecond.every(Math.max(tickStep(start3, stop2, count2), 1));
...
function useDrawingArea() {
  const {
    ...
    bottom: bottom3,
    right: right3
  } = React42.useContext(DrawingContext);
  return React42.useMemo(() => ({
    ...
    bottom: bottom3,
    right: right3
  }), [height2, left3, top3, width2, bottom3, right3]);
}
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React43.useContext(SeriesContext);
...
function useSvgRef() {
  const svgRef = React44.useContext(SvgContext);
  if (svgRef === void 0) {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  React45.useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      const outsideX = svgPoint.x < left3 || svgPoint.x > left3 + width2;
      const outsideY = svgPoint.y < top3 || svgPoint.y > top3 + height2;
  ...
  }, [svgRef, dispatch, left3, width2, top3, height2, usedYAxis, yAxis, usedXAxis, xAxis, disableAxisListener]);
};
...
var HighlighContext = React47.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React47.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React47.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime20.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
function useSeries() {
  const series = React50.useContext(SeriesContext);
  if (series === void 0) {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime21.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime21.jsxs)(React51.Fragment, {
...
function useChartGradient() {
  ...
  return React53.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React53.useContext(CartesianContext);
  return (0, import_jsx_runtime23.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime23.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime23.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var ChartContainer = React54.forwardRef(function ChartContainer2(props, ref) {
  const {
    width: width2,
    height: height2,
    series,
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime24.jsx)(DrawingProvider, {
    width: width2,
    height: height2,
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime24.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime24.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime24.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime24.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime24.jsxs)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime24.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React55.useRef(false);
  const [width2, setWidth] = React55.useState(0);
  const [height2, setHeight] = React55.useState(0);
  const computeSize = React55.useCallback(() => {
...
var ResponsiveChartContainer = React56.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded19);
  const [containerRef, width2, height2] = useChartContainerDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime25.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width2 && height2 ? (0, import_jsx_runtime25.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
var ClassNameConfiguratorContext = React57.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass3) {
  ...
  } = React57.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
// node_modules/@mui/base/utils/useSlotProps.js
var _excluded20 = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded20);
...
var _excluded21 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded21);
  const _ref = styleProps ?? {}, {
    angle,
    textAnchor,
    dominantBaseline
  } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded24);
  const wordsByLines = React60.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime27.jsx)("text", _extends({}, textProps, {
    x: x2,
    y: y2,
    textAnchor,
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime27.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   * Text displayed.
   */
  text: import_prop_types24.default.string.isRequired
} : void 0;
...
function ChartsXAxis(inProps) {
  ...
  const {
    xAxisIds
  } = React62.useContext(CartesianContext);
  const _React$useContext = React62.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded25);
  ...
  const axisTickLabelProps = useSlotProps({
    ...
    additionalProps: {
      style: _extends({
        textAnchor: "middle",
        dominantBaseline: position3 === "bottom" ? "hanging" : "auto",
  ...
  return (0, import_jsx_runtime28.jsxs)(AxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime28.jsx)(Line, _extends({
      x1: xScale.range()[0],
      x2: xScale.range()[1],
      ...
      return (0, import_jsx_runtime28.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime28.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime28.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime28.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime28.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
var _excluded26 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const {
    yAxisIds
  } = React63.useContext(CartesianContext);
  const _React$useContext = React63.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded26);
  ...
  const axisTickLabelProps = useSlotProps({
    ...
    additionalProps: {
      style: _extends({
        ...
        textAnchor: position3 === "right" ? "start" : "end",
  ...
  return (0, import_jsx_runtime29.jsxs)(AxisRoot, {
    transform: `translate(${position3 === "right" ? left3 + width2 : left3}, 0)`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime29.jsx)(Line, _extends({
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      className: classes.line
      ...
      return (0, import_jsx_runtime29.jsxs)("g", {
        transform: `translate(0, ${offset2})`,
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime29.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime29.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime29.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime29.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React64.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime30.jsxs)(React64.Fragment, {
    children: [topId && (0, import_jsx_runtime30.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime30.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime30.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime30.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
function getDocumentRect(element) {
  ...
  if (getComputedStyle(body || html).direction === "rtl") {
    x2 += max3(html.clientWidth, body ? body.clientWidth : 0) - width2;
  }
  return {
    width: width2,
    height: height2,
...
var Portal = React65.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React65.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React65.isValidElement(children)) {
      ...
      return React65.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime31.jsx)(React65.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime31.jsx)(React65.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(React67.Fragment, {
...
function useMouseTracker() {
  const svgRef = React68.useContext(SvgContext);
  const [mousePosition, setMousePosition] = React68.useState(null);
  React68.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime34.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime34.jsx)("tbody", {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types31.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types31.default.shape({
    ...
    type: import_prop_types31.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types31.default.object.isRequired,
...
var ZAxisContext = React70.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React70.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  return (0, import_jsx_runtime35.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
true ? ZAxisContextProvider.propTypes = {
   ...
   */
  zAxis: import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React71.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
    yAxisIds
  } = React71.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
  } = React71.useContext(ZAxisContext);
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  content: import_prop_types33.default.elementType,
  contentProps: import_prop_types33.default.shape({
    classes: import_prop_types33.default.object,
    getColor: import_prop_types33.default.func,
    itemData: import_prop_types33.default.shape({
      ...
      type: import_prop_types33.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types33.default.object,
...
var Typography = React72.forwardRef(function Typography2(inProps, ref) {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime38.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime38.jsx)("thead", {
        children: (0, import_jsx_runtime38.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime38.jsx)(Typography_default, {
      ...
      }), (0, import_jsx_runtime38.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime38.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime38.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React74.useContext(CartesianContext);
  const {
    zAxisIds,
    zAxis
  } = React74.useContext(ZAxisContext);
  const series = React74.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React74.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React74.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types36.default.shape({
    x: import_prop_types36.default.shape({
      index: import_prop_types36.default.number,
      value: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number, import_prop_types36.default.string]).isRequired
    }),
    y: import_prop_types36.default.shape({
      index: import_prop_types36.default.number,
      value: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number, import_prop_types36.default.string]).isRequired
    })
  }).isRequired,
  ...
  contentProps: import_prop_types36.default.shape({
    axis: import_prop_types36.default.object,
    axisData: import_prop_types36.default.shape({
      x: import_prop_types36.default.shape({
        index: import_prop_types36.default.number,
        value: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number, import_prop_types36.default.string]).isRequired
    ...
    axisValue: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    dataIndex: import_prop_types36.default.number,
    series: import_prop_types36.default.arrayOf(import_prop_types36.default.object),
...
var ChartsTooltipRoot = styled_default2(Popper, {
  name: "MuiChartsTooltip",
  slot: "Root",
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime40.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime40.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime40.jsx)(ChartsAxisTooltipContent, {
...
var _excluded30 = ["rotate", "dominantBaseline"];
var _excluded210 = ["label"];
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React76.useMemo(
  ...
  const padding2 = React76.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React76.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded30);
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React76.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
  ...
  const gapX = React76.useMemo(() => {
    switch (position3.horizontal) {
      case "left":
  ...
  }, [position3.horizontal, padding2.left, padding2.right, totalWidth, legendWidth]);
  const gapY = React76.useMemo(() => {
    switch (position3.vertical) {
      case "top":
        return padding2.top;
      case "bottom":
  ...
  }, [position3.vertical, padding2.top, padding2.bottom, totalHeight, legendHeight]);
  if (hidden) {
    return null;
  }
  return (0, import_jsx_runtime41.jsx)(NoSsr, {
    children: (0, import_jsx_runtime41.jsx)(ChartsLegendRoot, {
      className: classes.root,
      children: seriesWithPosition.map(({
        ...
        children: [(0, import_jsx_runtime41.jsx)("rect", {
          ...
          fill: color3
        }), (0, import_jsx_runtime41.jsx)(ChartsText, {
          style: labelStyle,
          text: label,
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types38.default.oneOf(["column", "row"]).isRequired,
  drawingArea: import_prop_types38.default.shape({
    bottom: import_prop_types38.default.number.isRequired,
    height: import_prop_types38.default.number.isRequired,
    left: import_prop_types38.default.number.isRequired,
    right: import_prop_types38.default.number.isRequired,
    top: import_prop_types38.default.number.isRequired,
    width: import_prop_types38.default.number.isRequired
  }).isRequired,
  /**
  ...
  seriesToDisplay: import_prop_types38.default.arrayOf(import_prop_types38.default.shape({
    color: import_prop_types38.default.string.isRequired,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = useDrawingArea();
  const series = React77.useContext(SeriesContext);
  ...
  return (0, import_jsx_runtime42.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React78.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime43.jsxs)(React78.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime43.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime43.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime43.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime43.jsx)(ChartsAxisHighlightPath, {
...
true ? ChartsAxisHighlight.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  x: import_prop_types40.default.oneOf(["band", "line", "none"]),
  y: import_prop_types40.default.oneOf(["band", "line", "none"])
} : void 0;
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React79.useContext(InteractionContext);
  const {
    dispatch: dispatchHighlight
  } = React79.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
var _excluded31 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "highlightScope", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle"];
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types41.default.shape({
    faded: import_prop_types41.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types41.default.oneOf(["item", "none", "series"])
  }),
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React81.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React81.useMemo(() => data.map((item, itemIndex) => {
    const {
      isHighlighted,
      isFaded
...
var _excluded33 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
var _excluded211 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "arcLabelRadius", "outerRadius", "cornerRadius"];
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime45.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime45.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types43.default.string,
  ...
  isFaded: import_prop_types43.default.bool.isRequired,
  isHighlighted: import_prop_types43.default.bool.isRequired
} : void 0;

// node_modules/@mui/x-charts/esm/PieChart/PieArcLabelPlot.js
var import_jsx_runtime47 = __toESM(require_jsx_runtime());
var _excluded35 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "highlightScope", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
var _excluded212 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius"];
...
function getItemLabel(arcLabel, arcLabelMinAngle, item) {
  ...
  if (typeof arcLabel === "string") {
    return (_a = item[arcLabel]) == null ? void 0 : _a.toString();
  }
  ...
  return (0, import_jsx_runtime47.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      let {
        ...
        arcLabelRadius: aLR,
        cornerRadius: cR
      } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded212);
      return (0, import_jsx_runtime47.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["formattedValue", "label", "value"]), import_prop_types44.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types44.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types44.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types44.default.number,
  data: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    color: import_prop_types44.default.string.isRequired,
    endAngle: import_prop_types44.default.number.isRequired,
    formattedValue: import_prop_types44.default.string.isRequired,
    ...
    index: import_prop_types44.default.number.isRequired,
    label: import_prop_types44.default.string,
    padAngle: import_prop_types44.default.number.isRequired,
    startAngle: import_prop_types44.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types44.default.shape({
    additionalRadius: import_prop_types44.default.number,
    arcLabelRadius: import_prop_types44.default.number,
    color: import_prop_types44.default.string,
    cornerRadius: import_prop_types44.default.number,
    innerRadius: import_prop_types44.default.number,
    outerRadius: import_prop_types44.default.number,
    paddingAngle: import_prop_types44.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types44.default.shape({
    additionalRadius: import_prop_types44.default.number,
    arcLabelRadius: import_prop_types44.default.number,
    color: import_prop_types44.default.string,
    cornerRadius: import_prop_types44.default.number,
  ...
  highlightScope: import_prop_types44.default.shape({
    faded: import_prop_types44.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types44.default.oneOf(["item", "none", "series"])
  }),
  id: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]).isRequired,
  /**
   * The radius between circle center and the beginning of the arc.
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types44.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const seriesData = React85.useContext(SeriesContext).pie;
  const {
    left: left3,
    top: top3,
    width: width2,
    height: height2
  } = React85.useContext(DrawingContext);
  ...
  return (0, import_jsx_runtime48.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime48.jsx)("g", {
        ...
        children: (0, import_jsx_runtime48.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime48.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime48.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(StyledText, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(StyledText2, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime51.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime51.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime52.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime52.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime52.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime52.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime52.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  });
...
true ? PieChart.propTypes = {
  ...
  xAxis: import_prop_types46.default.arrayOf(import_prop_types46.default.shape({
    axisId: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
    classes: import_prop_types46.default.object,
    ...
    max: import_prop_types46.default.oneOfType([import_prop_types46.default.instanceOf(Date), import_prop_types46.default.number]),
    min: import_prop_types46.default.oneOfType([import_prop_types46.default.instanceOf(Date), import_prop_types46.default.number]),
    position: import_prop_types46.default.oneOf(["bottom", "left", "right", "top"]),
